...
class ProteinGNN(torch.nn.Module):
    ...
    def __init__(self, config, dataset):
        ...
        self.norm_prot = LayerNorm(hidden_channels * 2)  # Due to SkipCat
    ...
    def forward(self, x_dict, edge_index_dict, batch, return_attention_weights=None):
        ...
        x_gnn1 = {k: self.norm_gnn1(v) for k, v in x_gnn1.items()}
        ...
        x_gnn2 = {k: self.norm_gnn2(v) for k, v in x_gnn2.items()}
